            ...
            <MainLayout>
                <section className="ml-20">
                    <section className="flex justify-center">
                        <div className="w-[1100px] h-[220px] m-10 rounded-2xl bg-gray"></div>
                    </section>

                    <section className="flex justify-center m-5">
                        <input type="text" placeholder="Busque o livro que procura" className="w-[500px] pl-5 py-2 mb-5 border border-gray rounded-full focus:outline-none focus:border-purple"/>
                        <button></button>
                    </section>
